                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('pos_management'))
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/pos*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   title="{{\App\CPU\translate('Add New Order')}}" href="{{route('admin.pos.index')}}">
                                    <i class="tio-shopping nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CPU\translate('Add New Order')}}</span>
                                </a>
                            </li>
                        @endif
                        <!-- End POS -->
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('product_management'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/product-weight*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:" title="{{\App\CPU\translate('brands')}}">
                                    <i class="tio-star nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Product Weight</span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{Request::is('admin/product-weight*')?'block':'none'}}">
                                    <li class="nav-item {{Request::is('admin/product-weight/create')?'active':''}}"
                                        title="{{\App\CPU\translate('add_new')}}">
                                        <a class="nav-link " href="{{route('admin.product-weight.create')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('add_new')}}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{Request::is('admin/product-weight')?'active':''}}"
                                        title="{{\App\CPU\translate('List')}}">
                                        <a class="nav-link " href="{{route('admin.product-weight.index')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('List')}}</span>
                                        </a>
                                    </li>
                        ...
                        <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/coupon*') || Request::is('admin/deal*'))?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/deal/fshipping') || Request::is('admin/deal/edit*'))?'active':''}}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                       href="{{route('admin.deal.fshipping')}}"
                       ...
                       -->
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/messages/chat/seller')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="{{route('admin.messages.chat', ['type' => 'seller'])}}"
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <a class="nav-link " href="{{route('admin.sellers.withdraw_list')}}"
                                       title="{{\App\CPU\translate('withdraws')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{\App\CPU\translate('Withdraw')}}</span>
                                    </a>
                                </li>
                                </ul>
                            </li>
                        ...
                        <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/business-settings/mail') || Request::is('admin/business-settings/sms-module') || Request::is('admin/business-settings/captcha') || Request::is('admin/social-login/view') || Request::is('admin/business-settings/map-api') || Request::is('admin/business-settings/payment-method') || Request::is('admin/business-settings/fcm-index'))?'active':''}}">
                            <a class="nav-link " href="{{route('admin.business-settings.payment-method.index')}}"
                               title="{{\App\CPU\translate('3rd_party')}}">
                                ...
                                <span class="text-truncate">{{\App\CPU\translate('payment_method')}}</span>
                            </a>
                        </li>
