                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{(Request::is('seller/product*'))?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{Request::is('seller/add-popular-cat') || Request::is('seller/product/stock-limit-list/in_house')?'active':''}}">
                                    <a class="nav-link " href="{{route('seller.create.popular-category')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">Popular Category</span>
                                    </a>
                                </li>
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ (Request::is('seller/coupon*') || Request::is('seller/deal*')) ? 'active' : ''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ (Request::is('seller/coupon*') || Request::is('seller/deal*')) ? 'block' : 'none'}}">
                                ...
                                <li class="navbar-vertical-aside-has-menu {{(Request::is('seller/deal/flash') || (Request::is('seller/deal/update*')))?'active':''}}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                ...
                                <li class="navbar-vertical-aside-has-menu {{(Request::is('seller/deal/day') || (Request::is('seller/deal/day-update*')))?'active':''}}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                       href="{{route('seller.deal.day')}}"
                                ...
                                <!--<li class="navbar-vertical-aside-has-menu {{(Request::is('seller/deal/feature') || Request::is('seller/deal/edit*'))?'active':''}}">-->
                                <!--    <a class="js-navbar-vertical-aside-menu-link nav-link"-->
                                <!--       href="{{route('seller.deal.feature')}}"-->
...
{{--                        </li>--}}
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ (Request::is('seller/coupon*') || Request::is('seller/deal*')) ? 'active' : ''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                               href="javascript:" title="{{\App\CPU\translate('Finance')}}">
                                <i class="tio-users-switch nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CPU\translate('Finance')}}</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ (Request::is('seller/coupon*') || Request::is('seller/deal*')) ? 'block' : 'none'}}">
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="{{route('seller.business-settings.withdraw.list')}}">
                                ...
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate text-capitalize">
                                        {{\App\CPU\translate('withdraw_list')}}
                                    </span>
                            </a>
                        </li>
                                <li class="navbar-vertical-aside-has-menu">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                       href="{{route('seller.transaction.order-list')}}"
                                       title="{{\App\CPU\translate('Seller_Report')}}">
                                        <i class="tio-chart-bar-1 nav-icon"></i>
                                        <span
                                            class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Seller Report</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('seller/shop*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="{{route('seller.shop.view')}}">
                                ...
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    {{\App\CPU\translate('Shop_Settings')}}
                                </span>
                            </a>
                        </li>
