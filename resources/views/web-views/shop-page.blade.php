...
@php($decimal_point_settings = \App\CPU\Helpers::get_business_settings('decimal_point_settings'))
                                        ...
                                        <div class="card __inline-71">
                                            ...
                                            <div class="card-header p-1 flex-between" >
                                                <div class="d-flex ">
                                                    ...
                                                    <!--    {{$category['name']}}-->
                                                    <!--</label>-->
                                                    <!--{{route('shopView',['id'=> $seller_id,'category_id'=>$category['id']])}}'-->
                                            ...
                                            <div class="card-body {{Session::get('direction') === "rtl" ? 'mr-2' : 'ml-2'}}" id="collapse-{{$category['id']}}"
                                                ...
                                                @foreach($category->childes as $child)
                                                    <div class=" for-hover-lable card-header p-1 flex-between">
                                                        ...
                                                        <!--    {{$child['name']}}-->
                                                        <!--</label>-->
                                                        <!--{{route('shopView',['id'=> $seller_id,'category_id'=>$child['id']])}}-->
                                                        <a href="{{route('shopView',['id'=> $seller_id,'category_id'=>$child['id']])}}">
                                                    ...
                                                    <div class="card-body {{Session::get('direction') === "rtl" ? 'mr-2' : 'ml-2'}}" id="collapse-{{$child['id']}}"
                                                        ...
                                                        @foreach($child->childes as $ch)
                                                            <div class="card-header p-1 flex-between">
                                                                ...
                                                                <!--    {{$ch['name']}}-->
                                                                <!--</label>-->
                                                                <a href="{{route('shopView',['id'=> $seller_id,'category_id'=>$ch['id']])}}">
                                                                <!--<a href="{{url('shopViewbycat',['id'=> $seller_id,'category_id'=>$category['id']])}}">-->
                        ...
                        <div class="">
                            ...
                            <div class="widget widget-categories banner-widget  mb-4">
                                ...
                                <div class="accordion mt-2 banner_accordion" id="shop-categories">
                                    ...
                                    onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                    alt=""  onclick="location.href='{{route('shopView',['id'=> $seller_id,'category_id'=>$shop_cat['cat_id']])}}'">
                                @else                              
                                <p>ad</p>
                                @endif
                        ...
                        <div class="">
                            ...
                            <div class="widget widget-categories banner-widget mb-4 ">
                                ...
                                <div class="accordion mt-2" id="shop-categories">
                                    ...
                                    onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                    alt=""  onclick="location.href='{{route('shopView',['id'=> $seller_id,'category_id'=>$shop_cat2['cat_id']])}}'">
                                @else                              
                                <p>ad</p>
                                @endif
            ...
            <div class="col-lg-9 product-div">
               ...
               <div class="row d-flex justify-content-end">
                ...
                <div class="row" id="ajax-products">
                    <div style="Background:black; color:white;  width: 100%; text-align:center; padding:1%; font-size:16px; font-weight:bold;margin-bottom: 5px;"> Top/ Recomended Product </div>
                    <div class="col-md-12">
                ...
                <div class="row" id="ajax-products">
                  @if(empty($shop->side_banner3) && empty($shop->side_banner4))  
                 ...
                 <div class="col-md-6 col-sm-12 col-xl-6">
                     <aside class=" hidden-xs SearchParameters" id="SearchParameters">
                        ...
                        <div class=" rounded-lg " id="shop-sidebar">
                            <div class="">
                                <!-- Categories-->
                                <div class="widget widget-categories mb-4 " style="">
                                    <div>
                                        <div class="d-inline">
                                            <!-- <h3 class="widget-title font-bold __text-18px d-inline">Side Bannar3 </h3> -->
                                        </div>
                                    </div>
    
                                    @if(!empty($shop_cat3))
                                    <div class="accordion mt-2" id="shop-categories" style=" margin-bottom:5%;">
                                        
                                        <img class="__shop-page-banner side_banner for-hover-lable cursor-pointer"
                                        style="height: auto;width: 100%;"
                                        src="{{asset('storage/app/public/shop/banner')}}/{{$shop->side_banner3}}"
                                        onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                        alt=""  onclick="location.href='{{route('shopView',['id'=> $seller_id,'category_id'=>$shop_cat3['cat_id']])}}'" >
                                    @else
                                    <p>ad</p>
                                    @endif
                                    </div>
                 ...
                 <div class="col-md-6 col-sm-12 col-xl-6"><aside class=" hidden-xs SearchParameters" id="SearchParameters">
                    <!-- Categories Sidebar-->
                    <div class=" rounded-lg " id="shop-sidebar">
                        <div class="">
                            <!-- Categories-->
                            <div class="widget widget-categories mb-4 " style="">
                                ...
                                <div class="accordion mt-2" id="shop-categories" style=" margin-bottom:5%;">
                                    ...
                                    onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                    alt=""  onclick="location.href='{{route('shopView',['id'=> $seller_id,'category_id'=>$shop_cat4['cat_id']])}}'" >
                                @else
                                <p>ad</p>
                                @endif
                                </div>
    ...
    @foreach ($popularProducts as $categoryId => $products)
        @if (!$products->isEmpty()) <!-- Check if there are products in this category -->
            <br />
            <div style="background: black; color: white; width: 100%; text-align: center; padding: 1%; font-size: 16px; font-weight: bold;margin-bottom: 8px;">
                {{ $products->first()->category->name }}
            </div>
           
                <div class="carousel-wrap p-1">
    <div class="owl-carousel owl-theme top_products_list" id="">
                @foreach ($products as $key => $cat)
                    @if ($cat->category) <!-- Check if the product has a category -->
                       
                            <div class="product-single-hover">
                                <div class="overflow-hidden position-relative">
                                    <div class="inline_product clickable d-flex justify-content-center" style="cursor: pointer; background: {{$web_config['primary_color']}}10; border-radius: 5px 5px 0px 0px;">
                                        @if($cat->discount > 0)
                                            <div class="d-flex" style="left: 8px; top: 8px;">
                                                <span class="for-discoutn-value p-1 pl-2 pr-2">
                                                    @if ($cat->discount_type == 'percent')
                                                        {{ round($cat->discount, (!empty($decimal_point_settings) ? $decimal_point_settings : 0)) }}%
                                                    @elseif($cat->discount_type =='flat')
                                                        {{ \App\CPU\Helpers::currency_converter($cat->discount) }}
                                                    @endif
                                        ...
                                        <div class="d-flex d-block">
                                            <a href="{{ route('product', $cat->slug) }}">
                                                <img src="{{ \App\CPU\ProductManager::product_image_path('thumbnail') }}/{{ $cat['thumbnail'] }}" onerror="this.src='{{ asset('public/assets/front-end/img/image-place-holder.png') }}'">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="single-product-details">
                                        <div class="text-{{ Session::get('direction') === "rtl" ? 'right pr-3' : 'left pl-3' }}">
                                            <a href="{{ route('product', $cat->slug) }}">
                                                {{ Str::limit($cat['name'], 23) }}
                                            </a>
                                        </div>
                                        <div class="rating-show justify-content-between text-center">
                                            <span class="d-inline-block font-size-sm text-body">
                                                <label class="badge-style">( {{ $cat->reviews_count }} )</label>
                                            </span>
                                        </div>
                                            ...
                                            <div class="product-price text-center">
                                                @if($cat->discount > 0)
                                                    <strike style="font-size: 12px!important;color: #E96A6A!important;">
                                                        {{ \App\CPU\Helpers::currency_converter($cat->unit_price) }}
                                                    </strike><br>
                                                @endif
                                                <span class="text-accent">
                                                    {{ \App\CPU\Helpers::currency_converter(
                                                        $cat->unit_price - (\App\CPU\Helpers::get_product_discount($cat, $cat->unit_price))
                                                    ) }}
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="text-center quick-view">
                                        @if(Request::is('product/*'))
                                            <a class="btn btn--primary btn-sm" href="{{ route('product', $cat->slug) }}">
                                        ...
                                        @else
                                            <a class="btn btn--primary btn-sm"
                                                ...
                                                href="javascript:" onclick="quickView('{{$cat->id}}')">
                    ...
                    @endif <!-- End of check for product category -->
                @endforeach
            </div>
            </div>
            
        @endif <!-- End of check for products in this category -->
    @endforeach
</div>
