...
@php($decimal_point_settings = !empty(\App\CPU\Helpers::get_business_settings('decimal_point_settings')) ? \App\CPU\Helpers::get_business_settings('decimal_point_settings') : 0)
    ...
    @php($flash_deals=\App\Model\FlashDeal::with(['products'=>function($query){
            ...
            }])->where(['status'=>1])->where(['deal_type'=>'flash_deal'])->whereDate('start_date',
    ...
    @endif  
        ...
        @if ($business_mode == 'multi')
            @if(count($top_sellers) > 0)
                <div class="col-md-12 mt-2 mt-md-0 seller-card py-4" >
                    <div class="card __shadow h-100">
                        <div class="card-body">
                            <div class="row d-flex justify-content-between">
                                        ...
                                        @if($seller->shop)
                                            <div class="__m-5px __cate-item">
                                                <a href="{{route('shopView',['id'=>$seller['id']])}}">
                                                    <div class="__img circle" style="box-shadow: 0px 0px 5px rgb(221 141 25 / 61%);">
                                                    <img onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
...
<!--
  ...
  -->
   ...
   <!--Top rated and best selling-->
    ...
    <!--                    <a class="text-capitalize view-all-text "-->
    <!--                        href="{{ route('feature-deals') }}">{{ \App\CPU\translate('view_all')}}-->
    <!--                        <i class="czi-arrow-{{Session::get('direction') === "rtl" ? 'left mr-1 ml-n1 mt-1 float-left' : 'right ml-1 mr-n1'}}"></i>-->
    <!--                    </a>-->
    ...
    <!--                    <a href="" class="cursor-pointer d-block h-100 __cate-product-side-img">-->
    <!--                        <img class="h-100" onerror="this.src='{{asset('public/assets/front-end/img/feature.jpg')}}'"-->
    <!--                              src="{{asset('public/assets/front-end/img/bundle.jpg')}}">-->
    <!--                     </a>-->
    <!--                </div>-->
    <!--                 <div class="col-md-9 col-12 ">-->
    <!--                    <div class="row g-2" >-->
    <!--                      @foreach($featured_deals as $ftDeals)-->
    <!--                      @foreach($ftDeals->products as $key=>$product)-->
    <!--                      <div class="col-md-3 col-sm-4 col-6">-->
    <!--                 @include('web-views.partials._category-single-product',['product'=>$product->product, 'decimal_point_settings'=>$decimal_point_settings])        -->
    <!--                         </div>	-->
    <!--                        @endforeach-->
    <!--                      @endforeach-->
    <!--                     </div>-->
    ...
    @php($flash_deals=\App\Model\FlashDeal::with(['products'=>function($query){
            ...
            }])->where(['status'=>1])->where(['deal_type'=>'flash_deal'])->limit(2)->get())
      ...
      <!--              </div>-->
      <!--              <div class="category-product-view-all" >-->
      <!--                <a class="mt-2 text-capitalize view-all-text" href="{{route('flash-deals')}}">-->
      <!--                      {{ \App\CPU\translate('view_all')}}-->
      <!--                      <i class="czi-arrow-{{Session::get('direction') === "rtl" ? 'left mr-1 ml-n1 mt-1 float-left' : 'right ml-1 mr-n1'}}"></i>-->
      <!--                  </a>                        -->
      ...
      <!--              <div class="col-md-3 col-12">-->
      <!--                  <a href="" class="cursor-pointer d-block h-100 __cate-product-side-img">-->
      <!--                       <img class="h-100" onerror="this.src='{{asset('public/assets/front-end/img/flash.jpg')}}'"-->
      <!--                            src="">-->
      <!--                   </a>-->
      <!--              </div>-->
      <!--               <div class="col-md-9 col-12 ">-->
      <!--                  <div class="row g-2" >-->
      <!--                    @foreach($flash_deals as $fDeals)-->
    ...
    @php($free_shipping=\App\Model\FlashDeal::with(['products'=>function($query){
      ...
      <!--              </div>-->
      <!--              <div class="category-product-view-all" >-->
      <!--                <a class="mt-2 text-capitalize view-all-text" href="{{route('free-shipping')}}">-->
      <!--                      {{ \App\CPU\translate('view_all')}}-->
      <!--                      <i class="czi-arrow-{{Session::get('direction') === "rtl" ? 'left mr-1 ml-n1 mt-1 float-left' : 'right ml-1 mr-n1'}}"></i>-->
      <!--                  </a>                        -->
      ...
      <!--              <div class="col-md-3 col-12">-->
      <!--                  <a href="" class="cursor-pointer d-block h-100 __cate-product-side-img">-->
      <!--                       <img class="h-100" onerror="this.src='{{asset('public/assets/front-end/img/shipping.jpg')}}'"-->
      <!--                            src="">-->
      <!--                   </a>-->
      <!--              </div>-->
      <!--               <div class="col-md-9 col-12 ">-->
      ...
      <!--  </section>-->
        ...
        @php($discount_product = App\Model\Product::with(['reviews'])->active()->where('discount', '!=', 0)->limit(18)->get())
...
<section class="container rtl pb-4">
            ...
            <div class="__p-20px rounded bg-white">
                <div class="flex-wrap __gap-6px flex-between pl-xl-4">
                    ...
                    <div class="category-product-view-all" >
                      <a class="mt-2 text-capitalize view-all-text" href="{{route('products',['data_from'=>'discounted','page'=>1])}}">
                            {{ \App\CPU\translate('view_all')}}
                            <i class="czi-arrow-{{Session::get('direction') === "rtl" ? 'left mr-1 ml-n1 mt-1 float-left' : 'right ml-1 mr-n1'}}"></i>
                        </a>                        
                ...
                <div class="row mt-2 justify-content-between g-3">
                     ...
                     <div class="col-md-12 col-12 ">
                        <div class="row g-2" >
                         @foreach($discount_product as $prod)
         <div class="col-md-2 col-sm-4 col-6">
         @include('web-views.partials._category-single-product',['product'=>$prod,'decimal_point_settings'=>$decimal_point_settings])
        ...
        <div class="mt-sm-3 mb-3 brand-slider">
            <div class="owl-carousel owl-theme p-2" id="brands-slider">
                @foreach($brands as $brand)
                    <div class="text-center">
                        <a href="{{route('products',['id'=> $brand['id'],'data_from'=>'brand','page'=>1])}}" class="__brand-item" style="border: 2px solid #F77C08">
