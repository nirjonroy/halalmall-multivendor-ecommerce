...
<div class="p-2" style="margin-bottom: 20px">
    <div class="row product-review d-flex ">
        <div class="col-md-4 d-flex mb-3 {{Session::get('direction') === "rtl" ? 'pl-5' : 'pr-5'}}">
            <div
                ...
                <div
                    ...
                    <span class="font-size-sm mb-0 text-body" style="font-weight: 700;font-size: 12px;">By {{isset($productReview->user)?$productReview->user->f_name:'not exist'}}</span>
        ...
        @if($productReview->replies->count() > 0)
            ...
            @endphp
            <div class="row" style="width: 762px;margin-left: 77px;background: #e2f0ff;padding: 10px;">
                
                <div class="col-md-5 d-flex mb-3 {{Session::get('direction') === "rtl" ? 'pl-5' : 'pr-5'}}">
                    <div class="media media-ie-fix  {{Session::get('direction') === "rtl" ? 'ml-4 pl-2' : 'mr-4 pr-2'}}">
                        ...
                        <div
                            ...
                            class="media-body {{Session::get('direction') === "rtl" ? 'pr-3' : 'pl-3'}} text-body">
                            <p style="font-weight: 700;font-size: 12px;margin-bottom: 6px;">Respond By</p>
                ...
                <div class="col-md-2 text-body">
                    <span style="float: right;font-weight: 400;font-size: 13px;">{{$reply->updated_at->diffForHumans()}}</span>
                </div>
