                ...
                <div class="card-body">
                    <div class="col-12">
                        <form action="{{route('address-update')}}" method="post">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="address-city">{{\App\CPU\translate('Division')}}</label>
                                                            <select name="division" id="division" class="form-control" onchange="divisionsList();">
                                                                ...
                                                                <option value="Barishal" {{$shippingAddress->division == 'Barishal' ? 'selected' : '' }} >Barishal</option>
                                                                <option value="Chattogram" {{$shippingAddress->division == 'Chattogram' ? 'selected' : '' }} >Chattogram</option>
                                                                <option value="Dhaka" {{$shippingAddress->division == 'Barishal' ? 'Dhaka' : '' }} >Dhaka</option>
                                                                <option value="Khulna" {{$shippingAddress->division == 'Barishal' ? 'Khulna' : '' }} >Khulna</option>
                                                                <option value="Mymensingh" {{$shippingAddress->division == 'Mymensingh' ? 'selected' : '' }} >Mymensingh</option>
                                                                <option value="Rajshahi" {{$shippingAddress->division == 'Rajshahi' ? 'selected' : '' }} >Rajshahi</option>
                                                                <option value="Rangpur" {{$shippingAddress->division == 'Rangpur' ? 'selected' : '' }} >Rangpur</option>
                                                                <option value="Sylhet" {{$shippingAddress->division == 'Sylhet' ? 'selected' : '' }} >Sylhet</option>
                                                              </select>
                                    <!--<label for="city">{{\App\CPU\translate('Division')}}</label>-->

                                    <!--<input class="form-control" type="text" id="division" name="division" value="{{$shippingAddress->division}}" required>-->
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="city">{{\App\CPU\translate('City')}}</label>
                                    <select name="city" id="city" class="form-control" required onchange="thanaList();">
                                        <option value="{{ $shippingAddress->city }}">{{ $shippingAddress->city }}</option>
                                    </select>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="city">{{\App\CPU\translate('Thana')}}</label>
                                    <select name="thana" id="thana" class="form-control" required>
                                        <option value="{{ $shippingAddress->thana }}">{{ $shippingAddress->thana }}</option>
                                    </select>
                                    <!--<input class="form-control" type="text" id="thana" name="thana" value="{{$shippingAddress->thana}}" required>-->
                                </div>
                                <div class="form-group col-md-6">
