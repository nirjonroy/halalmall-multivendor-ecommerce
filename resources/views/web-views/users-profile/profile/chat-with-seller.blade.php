                                            ...
                                            <form
                                                ...
                                                @if( Request::is('chat/seller') )
                                                    <input type="text" id="hidden_value" hidden
                                                           value="{{$last_chat->shop_id}}" name="hidden_value">
                                                    @if($last_chat->shop)
                                                        <input type="text" id="seller_value" hidden
                                                               value="{{$last_chat->shop->seller_id}}" name="seller_value">
                                                    @endif
                                                @elseif( Request::is('chat/delivery-man') )
                                                    <input type="text" id="hidden_value_dm" hidden
                                                           value="{{$last_chat->delivery_man_id}}" name="hidden_value_dm">
                                                @endif
                    ...
                    success: function (data) {
                        ...
                        if (data.length != 0) {
                         ...
                         height="200" width="200" style="border-radius: 15% !important;" alt="">
                                ...
                                $('#seller_value').attr("value", shop_id);
                            });
                        } else {
                ...
                $.ajax({
                    ...
                    success: function (respons) {
                        ...
                        $(".msg_history").append(`
                            <div class="outgoing_msg" id="outgoing_msg">
                              <div class='send_msg'>
                                <img src="${respons.fileName}" onclick="window.open(this.src, '_blank');" class="rounded-circle border"
                         height="200" width="200" style="border-radius: 15% !important;float:right;" alt="">
                                <span class='time_date'> now</span>
                              </div>
                            </div>`
                        )
