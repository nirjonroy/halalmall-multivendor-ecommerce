                        ...
                        <div class="col-lg-7 col-md-8 col-12 mt-md-0 mt-sm-3" style="direction: {{ Session::get('direction') }}">
                            <div class="details __h-100">
                                ...
                                <div class="mb-3">
                                    ...
                                    @endif
                                    <span class="h3 font-weight-normal text-accent variant_prce">
                                    <?php
                                     ...
                                     ?>
                                     {{\App\CPU\Helpers::currency_converter($after_discount) }}
                                     <?php
                                    ?>
                                                ...
                                                <div class="tab-pane fade show active" id="overview" role="tabpanel">
                                                    <div class="row pt-2 specification">
                                                        <div class="text-body col-lg-12 col-md-12 overflow-scroll">
                                                          <span style="font-weight: bold;">In The Box: {!! $product['in_the_box'] !!}</span>
                                                        </div>
                            ...
                            @if(isset($product->seller->shop))
                                <div class="row">
                                    ...
                                    <div class="col-12 msg-option mt-2" id="msg-option">
                                            ...
                                            <form action="{{route('messages_store_first')}}" method="post">
