                                ...
                                <tr>
                                    ...
                                    <td>
                                       <div class="d-flex justify-content-center gap-2">
                                            ...
                                            @if($key == 0)
                                            <a class="btn btn-outline-info btn-sm square-btn" title="View" href="{{route('admin.color.view')}}">
                                            <i class="tio-invisible"></i>
                                            </a>
                                            @else 
                                            <!--<a class="btn btn-outline-info btn-sm square-btn" title="View" href="{{route('admin.size.view')}}">-->
                                            <!--<i class="tio-invisible"></i>-->
                                            <!--</a>-->
                                            @endif
                                       </div> 
