                ...
                <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    <form action="{{route('admin.color.store')}}" method="post">
                        ...
                        <div class="form-group"
                            ...
                            <label class="title-color" for="name">{{ \App\CPU\translate('Color')}} {{ \App\CPU\translate('Name')}}<span class="text-danger">*</span>
                                    </label>
                        ...
                        <div class="form-group"
                                    id="">
                            <input type="hidden" id="id">
                            <label class="title-color" for="name">{{ \App\CPU\translate('Color')}} {{ \App\CPU\translate('Code')}}<span class="text-danger">*</span>
                                   </label>
                        ...
                        <table id="datatable"
                            ...
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    ...
                                    <th class="text-center">{{ \App\CPU\translate('Color_Name')}} </th>
                                    <th class="text-center">{{ \App\CPU\translate('Color_Code')}} </th>
