...
<div class="item style24" style="height: 235px;">            
            @if ($order->id !== null)
                ...
                <img height="90" width="90" src="data:image/png;base64,{{ DNS2D::getBarcodePNG($order->id.' '.$order->payment_status.' '.$order->customer->f_name.' '.$order->customer->phone.' '.$order->order_amount,'QRCODE') }}" alt="barcode" />
               </div>
