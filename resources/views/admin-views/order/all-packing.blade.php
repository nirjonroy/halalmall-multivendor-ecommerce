               ...
               <div class="card h-100">
                  ...
                  <div class="card-body">
                     ...
                     <table class="table table-bordered" border="1" style="width: 100%;">
                        <tbody>
                           <tr>
                              <td style="font-size:9px">MARCHANT</td>
                           ...
                           <tr>
                              ...
                              @endphp
                              <td style="font-size:9px">Customer </td>
                              <td style="font-size:9px">
                            <?php
                             $shipping_address = App\Model\ShippingAddress::find($order->shipping_address);
                             if($shipping_address->address == null || !isset($shipping_address->address))
                             {
                                 echo 'No data';
                             } else {
                                 echo $shipping_address->division;
                                 echo ',';
                                 echo $shipping_address->city;
                                 echo "<br/>";
                                 echo $shipping_address->thana;
                                 echo ",";
                           ...
                           <tr>
                              <th scope="row">
                                 <div class="item style24" style="text-align: left !important;">
                                    <span
                                       class="barcode_site text-capitalize"></span>
                                    <span class="barcode_name text-capitalize"></span>
                                    @if ($order->id !== null)
                                    <div class="barcode_image" style="float:left !important;">
                                       @php
                                       $customerName = $order->customer ? $order->customer->f_name . ' ' . $order->customer->l_name : 'N/A';
                                       $customerPhone = $order->customer ? $order->customer->phone : 'N/A';
                                       $customerEmail = $order->customer ? $order->customer->email : 'N/A';
                                       ...
                                       $customerCityAddress = $order->customer ? $order->customer->city : 'N/A';
                                       @endphp
                                       <img height="60" width="60" src="data:image/png;base64,{{ DNS2D::getBarcodePNG($order->id.' '.$order->payment_status.' '.$customerName.' '.$customerPhone.' '.$order->order_amount,'QRCODE') }}" alt="barcode" />
                                       <br> <br/>
