                            ...
                            @foreach(json_decode($language) as $lang)
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <select
                                        ...
                                        name="category_id"
                                        id="category_id"
                                        onchange="getRequest('{{url('/')}}/admin/product/get-categories-click?id='+this.value,'sub-category-select','no-select')">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select
                                        ...
                                        onchange="getRequest('{{url('/')}}/admin/product/get-sub-categories-click?id='+this.value,'sub-sub-category-select','no2-select')">
                    ...
                    <div class="card mt-2 rest-part">
                        ...
                        <div class="card-body">
                            <div class="row align-items-end">
                                ...
                                <div class="col-12 sku_combination table-responsive form-group" id="sku_combinationss">
...
@push('script_2')
    ...
    <script>
        var imageCount = {{100-count(json_decode($product->images))}};
