                    ...
                    <form action="{{route('admin.deal.flash')}}" method="post" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name" class="title-color font-weight-medium text-capitalize">{{ \App\CPU\translate('minimum_discount_amount')}}</label>
                                    <input type="number" name="minimum_discount_amount" required class="form-control">
                                </div>
                                </div>
                                <div class="col-md-6">
                                <div class="form-group">
                                   <!-- <label for="name" class="title-color font-weight-medium text-capitalize">{{ \App\CPU\translate('user_type')}}</label> -->
                                    <input type="hidden" value="admin" name="user_type" required class="form-control">
                                </div>
                                </div>
                                </div>
                                ...
                                <td class="text-center">
                                    <div class="d-flex align-items-center justify-content-center gap-10">
                                        ...
                                        <a title="{{\App\CPU\translate('Delete')}}"
                                            href="{{route('admin.deal.delete',[$deal['id']])}}"
