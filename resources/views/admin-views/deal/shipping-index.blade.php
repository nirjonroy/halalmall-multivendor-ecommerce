                    ...
                    <div class="card-body">
                        <form action="{{route('admin.deal.flash')}}" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};" method="post">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <input type="text" name="deal_type" value="free_shipping"  class="d-none">
                                    @foreach(json_decode($language) as $lang)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center justify-content-center gap-10">
                                            <a class="h-30 d-flex gap-2 align-items-center btn btn-soft-info btn-sm border-info" href="{{route('admin.deal.fship-product',[$deal['id']])}}">
