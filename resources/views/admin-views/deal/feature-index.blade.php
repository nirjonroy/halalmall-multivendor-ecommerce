                            ...
                            @foreach($flash_deals as $k=>$deal)
                                <tr>
                                    ...
                                    <td><span class="font-weight-semibold">
                                        <?php
                                            if(!isset($deal['seller']) || $deal['seller'] == null)
                                            {
                                                echo 'Admin';
                                            } else 
                                            {
                                                echo $deal['seller']['f_name'];
                                            }
                                        ?>                                   
