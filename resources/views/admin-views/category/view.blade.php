                        ...
                        <table style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                            ...
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    ...
                                    <th class="text-center">{{ \App\CPU\translate('popular_category_status')}}</th>
                            ...
                            @foreach($categories as $key=>$category)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <label class="switcher mx-auto">
                                            <input type="checkbox" class="switcher_input popular-category-status"
                                                    id="{{$category['id']}}" {{$category->is_popular == 1?'checked':''}}>
                                            <span class="switcher_control"></span>
                                        </label>
                                    </td>
                                    <td>
...
<script>
  ...
  $('[data-toggle="tooltip"]').tooltip()
    ...
    $(document).on('change', '.popular-category-status', function () {
            ...
            $.ajax({
                url: "{{route('admin.category.popular-status')}}",
                method: 'POST',
                data: {
                    id: id,
