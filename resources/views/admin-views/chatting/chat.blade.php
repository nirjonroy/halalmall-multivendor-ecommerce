                ...
                <div class="col-xl-3 col-lg-4 chatSel">
                    <div class="card card-body px-0 h-100">
                        ...
                        <div class="inbox_people">
                           ...
                           <div class="inbox_chat d-flex flex-column mt-1" style="overflow-y: scroll;height: 400px;">
                                            ...
                                            <form class="mt-4" id="myForm">
                                                @csrf
                                                    <input type="text" id="hidden_value" hidden
                                                           value="{{$chatting->seller_id }}" name="seller_id">
                        ...
                        data.map((element, index) => {
                         ...
                         <br/>
                                    ...
                                    $(".msg_history").prepend(`
                                      <div class="outgoing_msg" id="outgoing_msg">
                                        <div class='sent_msg'>
                                        <p class="bg-c1 text-white rounded px-3 py-2 mb-1" id="receive_msg">${element.message}</p>                                                                           
                                ...
                                if(element.message == '' || element.message == null) {
                                    $(".msg_history").prepend(`
                                      <div class="incoming_msg" id="incoming_msg">
                                        <div class='sent_msg'>                                                                             
                                        <img src="{{asset('public/seller_to_admin_image/${element.image}')}}" onclick="window.open(this.src, '_blank');" class=""
                         height="200" width="200" style="border-radius: 15% !important;" alt="">
                         <br/>
                                          <span class='time_date'> ${time}    |    ${date}</span>
                                        </div>
                ...
                $.ajax({
                    ...
                    success: function (respons) {
                        ...
                        $(".msg_history").prepend(`
                                  <div class="outgoing_msg" id="outgoing_msg">
                                    <div class='sent_msg'>
                                    <img src="${respons.image}" onclick="window.open(this.src, '_blank');" class="rounded-circle border"
                         height="200" width="200" style="border-radius: 15% !important;" alt="">
