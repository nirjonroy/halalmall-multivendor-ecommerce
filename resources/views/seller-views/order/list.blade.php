    ...
    <div class="content container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3" style="text-align: right;">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right" style="text-align: center;">
                                            <li>
                                                <form action="{{ route('seller.orders.order-bulk-export', ['status' => $status, 'from' => $from, 'to' => $to, 'filter' => $filter, 'search' => $search]) }}" method="post">
                                                    @csrf
                                    ...
                                    <div class="col-md-4" style="">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right" style="text-align: center;">
                                            <li>
                                                <form action="{{ route('seller.orders.export-packing-data', ['status' => $status, 'from' => $from, 'to' => $to, 'filter' => $filter, 'search' => $search]) }}" method="post">
                                                    @csrf
                ...
                <form id="generate-invoices-form" action="{{ route('seller.orders.generate-multiple-invoices') }}" method="post" enctype="multipart/form-data">
                    @csrf
...
$(document).ready(function() {
    ...
    function downloadSelectedPackingPDF(selectedRecords) {
        $.ajax({
            type: 'POST',
            url: '{{ route('seller.orders.download-selected-packing-pdf') }}',
            data: {
