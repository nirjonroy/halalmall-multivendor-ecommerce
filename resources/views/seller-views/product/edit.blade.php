                            ...
                            @foreach(json_decode($language) as $lang)
                                ...
                                <div class="{{$lang != 'en'? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <select
                                            ...
                                            name="category_id"
                                            id="category_id"
                                            onchange="getRequest('{{url('/')}}/seller/product/get-categories-click?id='+this.value,'sub-category-select','no-select')">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select
                                            ...
                                            onchange="getRequest('{{url('/')}}/seller/product/get-sub-categories-click?id='+this.value,'sub-sub-category-select','no2-select')">
                                       
                                       
                                        @foreach($sub_cat as $cat)
                                        
                                        <?php
                                          $cats=\App\Model\Category::where('id', $cat)->first();
                                        ...
                                        <?php 
                                         if($sub_cat_test == '0') {
                                             ...
                                             ?>
                                             <option value="{{ $cats->id }}" {{ $cats->id == $product_category[1]->id ? 'selected' : '' }}>{{ $cats->name}}</option>
                                             <?php
                                         }
                                        ?>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select
                                           ...
                                           @foreach($sub_sub_cat as $s_cat)
                                        
                                        <?php
                                          $scats=\App\Model\Category::where('id', $s_cat)->first();
                                          
                                        ?>
                                        
                                        <?php
                                        if($sub_sub_cat_test == '0') {
                                             ?>
                                            
                                             <?php
                                         } else {
                                             ?>
                                             <option value="{{ $scats->id }}" {{ $scats->id ==  $product_category[2]->id ? 'selected' : '' }}>{{ $scats->name }}</option>
                                             <?php
                                         }
                                    ...
                                    <div class="p-2 border border-dashed">
                                        ...
                                        <input id="products_previous_image_name" value="{{ $product->images }}" type="hidden" name="products_previous_image_name[]">
                                ...
                                <div class="col-md-4 mt-3 mt-md-0">
                                    ...
                                    <div class="row" id="meta_img">
                                        ...
                                        <input id="product_previous_thumb_image_name" type="hidden" value="{{ $product->thumbnail }}"  name="product_previous_thumb_image_name[]">
                    ...
                    <div class="card mt-2 rest-part">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="sku_combination" id="sku_combinationsss">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3 physical_product_show d-none" id="shipping_cost">
                                    ...
                                    <div class="col-md-3 mb-3 physical_product_show d-none" id="shipping_cost_multy">
                                        <div>
...
@push('script')
        ...
        $(function () {
            if (imageCount > 0) {
                ...
                $("#coba").spartanMultiImagePicker({
                	...
                	directUpload : {
                		...
                		url: '{{ route('seller.product.store_image')}}',
                		additionalParam : {
                			name : 'My Name'
                		},
            ...
            $("#thumbnail").spartanMultiImagePicker({
            	...
            	directUpload : {
            		status: true,
            		loaderIcon: `<div class="spinner-border text-primary"></div>`, // spinner class from bootstrap
            		url: '{{ route('seller.product.store_thumb_image')}}',
            		additionalParam : {
            			name : 'My Name'
            		},
            		success : function(data, textStatus, jqXHR){
    ...
    <script>        
        ...
        filebrowserUploadUrl: "{{route('seller.product.upload', ['_token' => csrf_token() ])}}",
