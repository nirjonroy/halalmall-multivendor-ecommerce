                                    ...
                                    <td>
                                        <div class="d-flex gap-10">
                                            ...
                                            <a class="btn btn-outline-info btn-sm square-btn"
                                             ...
                                             @if($p->is_recomended  == 0)
                                            <a  class="btn btn-outline-primary btn-sm square-btn"
                                                title="Recomanded Product"
                                                href="{{route('seller.product.recActive',[$p['id']])}}">
                                                <i class="fa-solid fa-thumbs-up"></i>
                                            </a>
                                            @else
                                            <a  class="btn btn-outline-primary btn-sm square-btn"
                                                title="UnRecomanded Product"
                                                href="{{route('seller.product.recInActive',[$p['id']])}}">
