                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3 ">
                                        ...
                                        <select class="js-example-basic-multiple form-control" id="category-select" name="category_id"
                                            onclick="getRequest('{{ url('/') }}/seller/product/get-categories-click?id='+this.value,'sub-category-select','no-select')"
                                            required>
                                    ...
                                    <div class="col-md-4 mb-3 ">
                                        ...
                                        <select class="js-example-basic-multiple form-control" name="sub_category_id"
                                            ...
                                            onclick="getRequest('{{ url('/') }}/seller/product/get-sub-categories-click?id='+this.value,'sub-sub-category-select','no2-select')">
                                        </select>
                                    </div>
                                    <div class="col-md-4 mb-3 ">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $(document).on('click', 'label.cat-title-label', function(){
                ...
                getRequest('{{ url('/') }}/seller/product/get-categories?id='+id,'','select');                
            });
