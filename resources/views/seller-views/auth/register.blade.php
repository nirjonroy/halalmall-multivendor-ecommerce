...
<div class="container py-5 rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
    ...
    <form class="__shop-apply" action="{{route('shop.apply')}}" id="form-id" method="post" enctype="multipart/form-data">
        ...
        <div class="card __card mb-3">
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-sm-6"><small class="text-danger">First Name***</small>
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control form-control-user" id="exampleLastName" name="l_name" value="{{old('l_name')}}" placeholder="{{\App\CPU\translate('last_name')}}">
                    </div>
                    <div class="col-sm-6 mt-4"><small class="text-danger">Email***</small>
                    ...
                    <div class="col-sm-6"><small class="text-danger">Password***</small>
                    ...
                    <div class="col-sm-6"><small class="text-danger">Confirm Password***</small>
        ...
        <div class="card __card">
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-sm-6 ">
                        <input type="text" class="form-control form-control-user" id="shop_name" name="shop_name" placeholder="{{\App\CPU\translate('shop_name')}}" value="{{old('shop_name')}}">
                    </div>
                    <div class="col-sm-6">
