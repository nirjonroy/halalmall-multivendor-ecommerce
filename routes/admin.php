...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'deal', 'as' => 'deal.','middleware'=>['module:promotion_management']], function () {
            ...
            // Free Shipping
            Route::get('free-shipping', 'DealController@shipping_index')->name('fshipping');
            // Submit Method For All Kinds Of Deal And Shipping
            ...
            Route::get('free-shipping-product/{deal_id}', 'DealController@fshipping_product')->name('fship-product');
        ...
        Route::group(['prefix' => 'category', 'as' => 'category.','middleware'=>['module:product_management']], function () {
            ...
            Route::post('popular-status', 'CategoryController@popular_status')->name('popular-status');
        ...
        Route::group(['prefix' => 'color', 'as' => 'color.','middleware'=>['module:product_management']], function () {
            Route::get('view', 'ColorController@index')->name('view');
            Route::get('fetch', 'ColorController@fetch')->name('fetch');
        ...
        Route::group(['prefix' => 'size', 'as' => 'size.','middleware'=>['module:product_management']], function () {
            Route::get('view', 'SizeController@index')->name('view');
            Route::get('fetch', 'SizeController@fetch')->name('fetch');
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.','middleware'=>['module:product_management']], function () {
            ...
            Route::post('/admin/product/upload-variation-image', 'ProductController@uploadVariationImage')->name('upload_variation_image');
        ...
        Route::resource('product-weight', 'ProductWeightController');
...
//                Route::get('app', 'LanguageController@index_app')->name('index-app');
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.','middleware'=>['module:order_management']], function () {
            ...
            Route::get('packing/{id}', 'OrderController@packing')->name('packing_details');
...
Route::post('generate-multiple-invoices', [OrderController::class, 'generateAllInvoices'])->name('generate-multiple-invoices')->withoutMiddleware(['module:order_management']);

Route::post('admin/orders/download-selected-packing-pdf', [OrderController::class, 'downloadSelectedPackingPDF'])
    ->name('download-selected-packing-pdf');
            ...
            Route::get('barcode/generate', 'OrderController@barcode_generate')->name('barcode.generate');
