...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::get('flash-deals', 'WebController@flash_deals')->name('flash-deals');
    Route::get('feature-deals', 'WebController@feature_deals')->name('feature-deals');
    Route::get('free-shipping', 'WebController@free_shipping')->name('free-shipping');
    ...
    Route::post('messages-store-first', 'ChattingController@messages_store_first')->name('messages_store_first');
    ...
    Route::get('shopViewbycat/{id}/{category_id}', 'WebController@shop_view_cat');
